 ...
 */
	...
	public class EasyApp extends Frame implements ActionListener, ItemListener, MouseListener, KeyListener
	 {
	   //Constructor 
		...
		private static final long serialVersionUID = 1L;  //this had to be called for the menu bar to work
	MenuBar menubar = addMenuBar();
	   ...
	   public EasyApp()
	   {
	     ...
	     setVisible(true);   //Makes the applet visable 
	     toFront();
	     requestFocus();
	   }
	   ...
	   public Button addButton(String text, int left, int top, int width, int height,  // Indicates button postioning in the JeopardyGame Class! 
...
//Allows the the user to type in their answer choice within the game
	 ...
	 /*=============================================
	  * Simplified Command Library to run the file
	  *=============================================
	  */
...
//Array
	  ...
	  // Stub versions of Listeners to satisfy interfaces 
	   ...
	   { Object source = evt.getSource();               //The sources allow for Methods in the JeopardyClass to activate within the If statements that pops up the question
...
//Recognized when something was clicked on	   
	 ...
	 /*=======================================================================================
	 *((IBIO))  CODE FOR THE INPUT AND OUTPUT USED IN THE JEOPARDY CLASS      - GUI version 
	 *========================================================================================
	 */
	   //Allows for a variety of answer types
